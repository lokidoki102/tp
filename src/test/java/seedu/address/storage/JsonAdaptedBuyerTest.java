...
public class JsonAdaptedBuyerTest {
    ...
    private static final String VALID_HOUSING_TYPE = ALICE_BUYER.getPreferredHousingType().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_HOUSING_TYPE,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_HOUSING_TYPE,
                        VALID_BUDGET, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, null, VALID_EMAIL, VALID_HOUSING_TYPE,
                        VALID_BUDGET, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_HOUSING_TYPE,
                        VALID_BUDGET, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, null, VALID_HOUSING_TYPE,
                        VALID_BUDGET, VALID_TAGS);
    ...
    public void toModelType_invalidHousingType_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_HOUSING_TYPE,
                        VALID_BUDGET, VALID_TAGS);
    ...
    public void toModelType_invalidBudget_throwsIllegalValueException() {
        JsonAdaptedBuyer buyer =
                new JsonAdaptedBuyer(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_HOUSING_TYPE,
                        INVALID_BUDGET, VALID_TAGS);
