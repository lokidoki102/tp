...
public class JsonAdaptedSellerTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedSeller seller =
                new JsonAdaptedSeller(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_HOUSES, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedSeller seller =
                new JsonAdaptedSeller(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_HOUSES, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedSeller seller = new JsonAdaptedSeller(VALID_NAME, null, VALID_EMAIL, VALID_HOUSES, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedSeller seller =
                new JsonAdaptedSeller(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_HOUSES, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedSeller seller = new JsonAdaptedSeller(VALID_NAME, VALID_PHONE, null, VALID_HOUSES, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedSeller seller =
                new JsonAdaptedSeller(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_HOUSES, invalidTags);
    ...
    public void toModelType_invalidHouses_throwsIllegalValueException() {
        ...
        invalidHouses.add(new JsonAdaptedHouse("InvalidType", "InvalidBlock", "InvalidLevel",
                "123456", "Maple Street", "120A", "12300000"));
        JsonAdaptedSeller seller = new JsonAdaptedSeller(VALID_NAME, VALID_PHONE, VALID_EMAIL,
