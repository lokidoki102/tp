...
public class EditBuyerCommand extends Command {
     ...
     * @param editBuyerDescriptor details to edit the seller with
     */
     ...
     * corresponding field value of the byer.
     */
    public static class EditBuyerDescriptor {
         ...
         */
        public EditBuyerDescriptor(EditBuyerCommand.EditBuyerDescriptor toCopy) {
            setName(toCopy.name);
        ...
        public boolean equals(Object other) {
            ...
            // instanceof handles nulls
            if (!(other instanceof EditBuyerCommand.EditBuyerDescriptor)) {
                return false;
            }

            EditBuyerCommand.EditBuyerDescriptor otherEditDescriptor = (EditBuyerCommand.EditBuyerDescriptor) other;
            return Objects.equals(name, otherEditDescriptor.name)
